...
![Project Management Dashboard](screenshots/report.webp)
...
5. Build the page to match `screenshots/report.webp`, apply the theme in [`../theme/giantbase-dark.json`](../theme/giantbase-dark.json), and save as `powerbi/ProjectManagement.pbix`.
